...
class UpdateBukuRequest extends FormRequest
{
    ...
    /**
     * Get custom conditional validation rules.
     */
        ...
        $validator->after(function ($validator) {
            if (
                ...
                $validator->errors()->add(
                    'bahasa',
                    'Untuk kategori Programming, bahasa harus Inggris.'
                );
            }
            ...
            if (
                ...
                $validator->errors()->add(
                    'stok',
                    'Buku yang terbit sebelum tahun 2000 hanya boleh memiliki stok maksimal 5.'
                );
            }
        });
    ...
    public function messages(): array
    {
        return [
            ...
            'bahasa.in'=> 'untuk kategori programming, bahasa harus diisi dengan "Inggris" atau "inggris".',
            'stok.max' => 'Stok untuk buku yang terbit sebelum 2020 tidak boleh melebihi 5.',
