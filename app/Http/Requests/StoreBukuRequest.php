...
class StoreBukuRequest extends FormRequest
{
    ...
    public function messages(): array
    {
     ...
     /** tambah conditional validation disini */
...
public function messagesWithValidator($validator)
    {
        return [
            'bahasa.required' => 'Bahasa wajib diisi.',
            'stok.max' => 'Stok untuk buku yang terbit sebelum tahun 2000 tidak boleh melebihi 5.',
        ];
    }  
